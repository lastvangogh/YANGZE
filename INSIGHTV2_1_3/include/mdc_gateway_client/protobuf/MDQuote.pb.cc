...
void protobuf_AssignDesc_MDQuote_2eproto() {
  ...
  static const int MDQuote_offsets_[18] = {
...
void MDQuote::SharedCtor() {
  ...
  ::memset(&mddate_, 0, reinterpret_cast<char*>(&mdsubbooktype_) -
    reinterpret_cast<char*>(&mddate_) + sizeof(mdsubbooktype_));
  _cached_size_ = 0;
}
