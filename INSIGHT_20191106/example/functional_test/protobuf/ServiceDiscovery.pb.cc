...
void protobuf_AddDesc_ServiceDiscovery_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "insight.model.ServerInfo\"6\n\nServerInfo\022\n"
    "\n\002ip\030\001 \001(\t\022\014\n\004port\030\002 \001(\005\022\016\n\006ipType\030\003 \001(\005"
    "B8\n\032com.htsc.mdc.insight.modelB\025ServiceD"
    "iscoveryProtoH\001\240\001\001b\006proto3", 506);
...
void ServerInfo::SharedCtor() {
  ...
  ::memset(&port_, 0, reinterpret_cast<char*>(&iptype_) -
    reinterpret_cast<char*>(&port_) + sizeof(iptype_));
  _cached_size_ = 0;
}
